...
export class Input implements OnInit {
    ...
    public readonly type: InputSignal<"text" | "number" | "email" | "phone" | "password"> = input<
    ...
    protected inputType: Signal<"text" | "tel" | "password" | "email"> = computed<
        "text" | "tel" | "password" | "email"
    >(() => {
